...
public class GestorBD {
	...
	public int insert_Familiar(Familiar p) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("N�o conseguiu inserir o familiar " + p.getNome_completo());
		}
		return row;		
	}
	...
	public ArrayList<Familiar> selectAll_Familiares(int idPaciente){
		...
		try {
			...
			e.printStackTrace();
			System.out.println("A base de dados n�o tem familiares");
		} finally {
			try {
				preparedStatement.close();
			} catch (Exception e) {
	...
	public int delete_Familiar(Familiar familiar){
		...
		try {
			...
			e.printStackTrace();
			System.out.println("N�o conseguiu apagar a familiar " + familiar.getNome_completo());
		}finally{
			try {
				preparedStatement.close();
			} catch (SQLException e) {
	...
	public int insert_Tecnico(Tecnico rm) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("N�o conseguiu inserir o tecnico " + rm.getNome_completo());
			row=0;
		}
		return row;
	...
	public Relacao select_Relacao_Familiar_FamiliarId(int id) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("A relacao com id " + id + " n�o existe na BD");
		} finally {
			try {
				preparedStatement.close();
			} catch (Exception e) {
