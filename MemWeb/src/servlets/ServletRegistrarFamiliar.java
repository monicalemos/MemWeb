...
//		Date data_nascimento = new Date(Integer.parseInt(dataNascimento[2]), Integer.parseInt(dataNascimento[1]), Integer.parseInt(dataNascimento[0]));
        ...
        try {
            ...
            if (eCuidador) {
                familiar = new Familiar(idFamiliar, nome, data_nascimento, localNascimento, morada, genero, estado_civil, profissao, eCuidador, nomeUtilizador, password);
            } else {
                familiar = new Familiar(idFamiliar, nome, data_nascimento, localNascimento, morada, genero, estado_civil, profissao, eCuidador);
            }
